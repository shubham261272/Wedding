...
class customeRegistrationClass(UserCreationForm):
    username=forms.CharField(label="Enter usename",widget=forms.TextInput(attrs={'class':'form-control'}))
    password1=forms.CharField(label='Enter password',widget=forms.PasswordInput(attrs={'class':'form-control'}))
    password2=forms.CharField(label='Enter password agian',widget=forms.PasswordInput(attrs={'class':'form-control'}))
...
class MyPasswordChangeForm(PasswordChangeForm):
    ...
    strip=False,widget=forms.PasswordInput(attrs={'autocomplete':'new-password','autofocus':True,'class':'form-control'}),help_text=password_validation.password_validators_help_text_html())
...
class myPasswordResetForm(PasswordResetForm):
    email=forms.EmailField(label=('Enter your valid Email'),max_length=254,widget=forms.EmailInput(attrs={'autocomplete':'email','class':'form-control'}))
